...
public class Magazine extends AbstractBook<Magazine> {
    ...
    public static void add(Set<AbstractBook> library, Scanner scanner, LibrarySupplier<Magazine> magazineLibrarySupplier) {
        ...
        if (option == 2) {
            int newIsbn = library.stream().mapToInt(AbstractBook::getIsbn).max().orElse(0) + new Random().nextInt(10, 1000);
